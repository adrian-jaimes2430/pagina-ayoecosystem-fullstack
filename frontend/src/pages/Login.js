    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0F172A] p-12 flex-col justify-between">
        <Link to="/" className="flex items-center gap-2 text-white">
          ...
          <span className="text-2xl font-bold">A&O Ecosistema</span>
        </Link>
        <div>
          <h2 className="text-4xl font-bold text-white mb-4 leading-tight">
            Bienvenido al
            <span className="block text-[#0F766E]">Ecosistema Empresarial</span>
          </h2>
          <p className="text-slate-300 text-lg">
            Accede a tu dashboard para gestionar productos, pedidos, comisiones y más.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">Accede a tu cuenta del ecosistema</p>
          </div>
            ...
            <div>
              ...
              <div className="relative mt-2">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 h-12 rounded-lg border-slate-200"
                  required
                />
                <button
                  type="button"
          ...
          <div className="mt-6">
            ...
            <Button
              ...
              variant="outline"
              className="w-full h-12 mt-4 rounded-lg border-slate-200 font-semibold"
            >
